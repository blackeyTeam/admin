			...
			'{@each content as it,k}',
				'<tr class="gradeX">',
                    ...
                    '<td class="center">',
                        ...
                        '<a data-toggle="modal" href="../shops/shops-info-edit.html?vendorId=${it.id}" class="btn btn-success btn-circle" title="开设店铺"><i class="fa fa-link"></i></a>',
                        '{@if it.hasAccount}',
                        '<a href="javascript:;" id="${it.id}" class="btn btn-info btn-circle btn-account" title="开设账户"><i class="fa fa-user"></i></a>',
                        '{@/if}',
                        '{@if !it.hasAccount}',
